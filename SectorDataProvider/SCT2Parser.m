    ...
    if (self = [super init])
    {
         ...
         regexStrings = [NSDictionary  dictionaryWithObjectsAndKeys:
                         @".*", [NSNumber numberWithInt:INFO_ELEMENT],
                                      ...
                                      @"(\\w+)\\s+(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})", [NSNumber numberWithInt:NDB_ELEMENT],
                                      @"(\\w+)\\s+(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([A-Za-z])", [NSNumber numberWithInt:AIRPORT_ELEMENT],
                                      @"(\\d+{1,}[\\w])\\s+(\\d+{1,}[\\w])\\s+(\\d+{3})\\s+(\\d+{3})\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})", [NSNumber numberWithInt:RUNWAY_ELEMENT],
                                      @"(\\w+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})", [NSNumber numberWithInt:FIXES_ELEMENT],
                                      @"(\\w+)\\s+(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})", [NSNumber numberWithInt:ARTCC_ELEMENT],
                                      @"(\\w+)\\s+(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,})\\s+(\\d{3}\\.\\d+\\.*\\d{1,})\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})", [NSNumber numberWithInt:ARTCC_HIGH_ELEMENT],                              
                                      @"(\\w+)\\s+(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})", [NSNumber numberWithInt:ARTCC_LOW_ELEMENT],
                                      @"([\\w\\s]+)\\s*(\\w+|)\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s*(\\w+|\\d+)*", [NSNumber numberWithInt:SID_ELEMENT],
                                      @"([\\w\\s]+)\\s*(\\w+|)\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s*(\\w+|\\d+)*", [NSNumber numberWithInt:STAR_ELEMENT],
                                      @"([\\w\\d\\-]+)\\s*(\\w+|)\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s*(\\w+|\\d+)*", [NSNumber numberWithInt:LOW_AIRWAY_ELEMENT],
                                      @"([\\w\\d\\-]+)\\s*(\\w+|)\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\w+|[NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s*(\\w+|\\d+)*", [NSNumber numberWithInt:HIGH_AIRWAY_ELEMENT],
                                      @"(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})", [NSNumber numberWithInt:GEO_ELEMENT],
                                      @"(\\w+|\\s+)\\s*(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})", [NSNumber numberWithInt:REGIONS_ELEMENT],
                                      @"\\\".*\\\"(\\d{3}\\.\\d+)\\s+([NnSs]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([WwEe]\\d{1,}\\.\\d{1,}\\.\\d{1,}\\.*\\d{1,})\\s+([\\w\\d]+)", [NSNumber numberWithInt:LABELS_ELEMENT], nil];
